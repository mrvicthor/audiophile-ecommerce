  ...
  return (
    <section className="px-6 my-[7.5rem]">
      <div className="h-[43.625rem] md:h-[39.5625rem] lg:h-[36.75rem] lg:max-w-[69.364rem] lg:mx-auto lg:grid lg:grid-cols-2 lg:gap-[7.8125rem] overflow-hidden rounded">
        <div className="h-[18.75rem] bg-[url('/images/image-gallery-1.jpg')] bg-cover bg-no-repeat bg-center rounded md:bg-[url('/images/image-gallery-1-tablet.jpg')] lg:bg-[url('/images/image-gallery-1-desktop.jpg')] lg:w-[33.75rem] lg:order-2 lg:h-full" />
